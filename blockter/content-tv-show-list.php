<?php
$posts_per_page = get_theme_mod( 'movies_list_per_page', 5 ) ? get_theme_mod( 'movies_list_per_page', 5 ) : 5;
$movie_settings = blockter_setup_movie_settings( 'ht_show', $posts_per_page );
?>
<div class="movie-wrapper">
	<?php blockter_render_movie_filter( $movie_settings['total_movies'], $movie_settings['orderby_options'], $movie_settings['sortby'], 'list' ); ?>
	...
	<div class="theme-movie-items row list-group movie-items">
		...
		if ( $movie_settings['movie']->have_posts() ) :
			while ( $movie_settings['movie']->have_posts() ) :
				...
				blockter_render_show_content( 'list' );
			endwhile;
		endif;
		?>
