...
<div class="flw container-async" id="<?php echo esc_attr( $tab_id ); ?>"
    ...
    <div class="category-filter flw<?php echo esc_attr($class_fw); ?>">
        ...
        <button data-filter="<?php echo esc_attr($terms[0]->taxonomy); ?>" data-term="all-terms" data-page="1"
            data-media="show" class="active"><?php esc_html_e('All', 'blockter'); ?></button>
        <?php endif; ?>
        <?php foreach ($terms as $term) : ?>
        <button data-filter="<?php echo esc_attr($term->taxonomy); ?>" data-term="<?php echo esc_attr($term->slug); ?>"
            data-page="1" data-media="show"
            data-postin="<?php echo esc_attr($postin); ?>"><?php echo esc_html($term->name); ?></button>
        <?php endforeach; ?>
    </div>
    <?php endif ?>
    <!--for mobile version-->
        ...
        <div class="flex-parent-cate">
            <div class="category-filter flw dropdown">
                ...
                <ul class="dropdown-content">
                    <?php if( $display_tab_all != 'no') : ?>
                    <li><button data-filter="<?php echo esc_attr($terms[0]->taxonomy); ?>" data-term="all-terms"
                            data-page="1" data-media="show"><?php esc_html_e('All', 'blockter'); ?></button></li>
                    <?php endif; ?>
                    <?php foreach ($terms as $term) : ?>
                    <li><button data-filter="<?php echo esc_attr($term->taxonomy); ?>"
                            data-term="<?php echo esc_attr($term->slug); ?>" data-page="1"
                            data-media="show"><?php echo esc_html($term->name); ?></button></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="movie-grid-items">
            ...
            <div class="movie-grid-it">
                ...
                <div class="movie-content">
                    <h6 class="mv-title"><a itemprop="url" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                    </h6>
    ...
    <div class="category-filter flw">
        ...
        <?php if($data == 'generes'): ?>
        <button data-filter="<?php echo esc_attr('mv_genre'); ?>" data-term="<?php echo esc_attr($item); ?>"
            data-media="show" data-postin="<?php echo esc_attr($postin); ?>"><?php echo esc_html($item); ?></button>
        <?php elseif($data == 'collections'): ?>
        <button data-filter="<?php echo esc_attr('mv_collection'); ?>" data-term="<?php echo esc_attr($item); ?>"
            data-media="show" data-postin="<?php echo esc_attr($postin); ?>"><?php echo esc_html($item); ?></button>
        <?php else: ?>
        <button data-filter="<?php echo esc_attr('mv_actor'); ?>" data-term="<?php echo esc_attr($item); ?>"
            data-media="show" data-postin="<?php echo esc_attr($postin); ?>"><?php echo esc_html($item); ?></button>
        <?php endif; ?>
        <?php endforeach; ?>
    </div>
        ...
        <div class="flex-parent-cate">
            <div class="category-filter flw dropdown">
                ...
                <ul class="dropdown-content">
                    ...
                    <?php foreach ($items as $item) : ?>
                    <?php if($data == 'generes'): ?>
                    <li><button data-filter="<?php echo esc_attr('mv_genre'); ?>"
                            data-term="<?php echo esc_attr($item); ?>"
                            data-media="show"><?php echo esc_html($item); ?></button></li>
                    <?php elseif($data == 'collections'): ?>
                    <li><button data-filter="<?php echo esc_attr('mv_collection'); ?>"
                            data-term="<?php echo esc_attr($item); ?>"
                            data-media="show"><?php echo esc_html($item); ?></button></li>
                    <?php else: ?>
                    <li><button data-filter="<?php echo esc_attr('mv_actor'); ?>"
                            data-term="<?php echo esc_attr($item); ?>"
                            data-media="show"><?php echo esc_html($item); ?></button></li>
                    <?php endif; ?>
                    <?php endforeach; ?>
    ...
    <div class="category-content specific<?php echo esc_attr($class_fw); ?>">
        ...
        <?php blockter_ajax_pager($qry,$page, $media = 'show'); ?>
    </div>
