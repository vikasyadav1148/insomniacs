...
if($data == 'collections'){
	...
	$args['mv_collection'] = $data_collections;
	$args['posts_per_page'] = $count;
}elseif($data == 'generes'){
	/*get posts by generes*/
	$args['mv_genre'] = $data_generes;
	$args['posts_per_page'] = $count;
}
if($data === 'trending') {
	$trend_raw = $atts['data_trending'] ?? 'movie-day';
	...
	$args=array(
            ...
            'tax_query'=>array(
                array(
                    ...
                    'terms'=>array($atts['data_trending'] ?? 'movie-day')
                )
            ),
				...
				<div class="movie-thumbnail">
					<?php if(!empty($thumbnail_id)): ?>
						<a href="<?php the_permalink(); ?>">
							<?php echo wp_get_attachment_image($thumbnail_id, array(300, 450));?>
