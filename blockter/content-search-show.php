...
if ( $movie_settings['movie']->have_posts() ) :
	...
	<div class="movie-wrapper">
		<?php blockter_render_show_filter( $movie_settings['total_movies'], $movie_settings['orderby_options'], $movie_settings['sortby'], 'grid' ); ?>
		<div class="theme-movie-items row list-group movie-items">
			<?php
			while ( $movie_settings['movie']->have_posts() ) :
				$movie_settings['movie']->the_post();
				blockter_render_show_content( 'grid' );
			endwhile;
			?>
		</div>
