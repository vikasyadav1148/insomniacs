<?php
/**
 * The Template for displaying Keyword (mv_keyword) search results.
 */
get_header();
			...
			<div class="col-md-9 col-lg-9">
				<div class="theme-blog-single">
					...
					<header class="page-header">
						<h3 class="page-title"><?php printf( esc_html__( 'Keywords matching: %s', 'blockter' ), '<em>' . esc_html( $find ) . '</em>' ); ?></h3>
					</header>
