...
var _import_button = __webpack_require__(48);
...
exports.default = {
  name: "searchmovie",
  components: {
    "import-button": _import_button2.default
  },
  data: function data() {
    return {
      selectedMovies: null,
  ...
  watch: {
    selectedOption: function selectedOption(newOption, oldOption) {
  ...
  methods: {
    ...
    asyncFind: function asyncFind(query) {
      ...
      if (importMovieLocalize['api_key']) {
        if (!this.selectedOption) {
          ...
          if (query != "") {
            this.isLoading = true;
            _axios2.default.get(this.getAllmovieURL, {
              params: {
                api_key: this.apiKey,
                query: query,
    ...
    customMovieLabel: function customMovieLabel(_ref) {
      var title = _ref.title;

      return "" + title;
    },
    customShowLabel: function customShowLabel(_ref2) {
      var name = _ref2.name;
...
exports.default = {
  ...
  computed: {
     ...
     */
    initialMovieData: function initialMovieData() {
      ...
      if (this.option == "movie") {
        ...
        if (importMovieLocalize['import_language'] == 'enable') {
          movie.languages = this.movieDetails.spoken_languages.map(function (language) {
            return language.name;
          }).join(", ");
        }
        if (importMovieLocalize['import_country'] == 'enable') {
          movie.country = this.movieDetails.production_countries.map(function (country) {
            return country.name;
          }).join(", ");
        }
        if (importMovieLocalize['import_production'] == 'enable') {
          movie.production = this.movieDetails.production_companies.map(function (company) {
            return company.name;
          }).join(", ");
        }
      ...
      if (importMovieLocalize['import_tv_creator'] == 'enable') {
        tv.creators = this.movieDetails['created_by'].map(function (creator) {
          return creator.name;
        }).join(', ');
      }
      ...
      if (importMovieLocalize['import_tv_production'] == 'enable') {
        tv.production = this.movieDetails.production_companies.map(function (company) {
          return company.name;
        }).join(", ");
      }
      ...
      if (importMovieLocalize['import_tv_season'] == 'enable') {
        var seasons = [];
        this.movieDetails.seasons.forEach(function (season) {
          var tempSeason = {
  ...
  watch: {
    currentmovies: {
      handler: function handler(newMovie, oldMovie) {
  ...
  methods: {
    ...
    getMovieDetails: function getMovieDetails() {
      ...
      var id = this.currentmovies.id;
      var query = this.option === 'movie' ? "https://api.themoviedb.org/3/movie/" + id : "https://api.themoviedb.org/3/tv/" + id;
      _axios2.default.get(query, {
        params: {
          api_key: this.api,
          language: importMovieLocalize.language
        }
     ...
     */
    getMovieCredits: function getMovieCredits() {
      var _this2 = this;

      var id = this.currentmovies.id;
      var query = this.option === 'movie' ? "https://api.themoviedb.org/3/movie/" + id + "/credits" : "https://api.themoviedb.org/3/tv/" + id + "/credits";
      _axios2.default.get(query, {
        params: {
          api_key: this.api,
          language: importMovieLocalize.language
        ...
        _this2.movieCredits = response.data;
      }).catch(function (error) {
        console.log(error);
      });
    },
     ...
     */
    createMovies: function createMovies() {
      var _this3 = this;

      var url = this.option === 'movie' ? importMovieLocalize.rest_url + "wp/v2/ht_movie" : importMovieLocalize.rest_url + "wp/v2/ht_show";
      return (0, _axios2.default)({
        ...
        _this3.postID = response.data.id;
      }).catch(function (error) {
        console.log(error);
      });
    },
     ...
     */
    getMovieVideos: function getMovieVideos() {
      var _this4 = this;

      if (this.option === 'movie') {
        if (importMovieLocalize['import_trailer'] == 'disable') return;
        var id = this.currentmovies.id;
        _axios2.default.get("https://api.themoviedb.org/3/movie/" + id + "/videos", {
          params: {
            api_key: this.api,
            language: importMovieLocalize.language
          }
        }).then(function (response) {
          _this4.movieVideos = response.data.results.map(function (result) {
            return result.key;
          });
        }).catch(function (error) {
          console.log(error);
        ...
        var _id = this.currentmovies.id;
        _axios2.default.get("https://api.themoviedb.org/3/tv/" + _id + "/videos", {
          params: {
            api_key: this.api,
            language: importMovieLocalize.language
          }
    ...
    getMovieKeywords: function () {

  var _this = this;

  var id = this.currentmovies.id;

  var url = this.option === 'movie'
  ...
  return _axios2.default.get(url, {
    ...
    var keywords = _this.option === 'movie'
      ? res.data.keywords.map(function (k) { return k.name; })
      : res.data.results.map(function (k) { return k.name; });

    if (!keywords.length) return Promise.resolve();

    var data = new FormData();
    data.append('keywords', keywords.join(',')); // ✅ FIXED

    return _axios2.default({
      method: 'post',
      url: importMovieLocalize.ajax_url,
      params: {
        action: 'ht_movie_add_keywords'
      },
      data: data,
      headers: {
        "X-WP-Nonce": importMovieLocalize.nonce
    ...
    if (response && response.data) {
      _this.movieKeywords = response.data.result;
    }
...
getWatchProviders: function () {
  ...
  return _axios2.default.get(url, {
    ...
    if (!res.data.results) return Promise.resolve();
    ...
    // 🔥 US + UK
    ['US', 'GB'].forEach(function (country) {

      if (!results[country]) return;

      let data = results[country];
    ...
    form.append('providers', JSON.stringify(providers)); // 🔥 send JSON

    return _axios2.default({
      method: 'post',
      url: importMovieLocalize.ajax_url,
      params: {
        action: 'ht_movie_add_networks'
      },
      data: form,
      headers: {
        "X-WP-Nonce": importMovieLocalize.nonce
    ...
    if (response && response.data) {
      _this.movieNetworks = response.data.result;
    }
    ...
    getMovieGenres: function getMovieGenres() {
      ...
      if (this.option == 'movie') {
        ...
        var data = new FormData();
        data.append('genres', this.movieDetails.genres.map(function (genre) {
          return genre.name;
        }));
        return (0, _axios2.default)({
          method: 'post',
          ...
          _this5.movieGenres = response.data.result;
        }).catch(function (error) {
          console.log(error);
        });
      } else {
        ...
        _data.append('genres', this.movieDetails.genres.map(function (genre) {
          return genre.name;
        }));
        return (0, _axios2.default)({
          method: 'post',
     ...
     */
    getMovieCast: function getMovieCast() {
      var _this6 = this;
      ...
      if (this.option == 'movie') {
        ...
        data.append('casts', casts.map(function (cast) {
          return cast.name;
        }));
        data.append('avatar_url', casts.map(function (cast) {
          return cast['profile_path'];
        }));
        data.append('gender', casts.map(function (cast) {
          return cast.gender;
        }));
      //  if (importMovieLocalize['import_castmoreinfo'] == 'enable') {
          data.append('person_id', casts.map(function (cast) {
            console.log(cast.id);
            return cast.id;
          }));
       ...
       // }
        ...
        return (0, _axios2.default)({
          ...
          _this6.movieCast = response.data.result;
        }).catch(function (error) {
        ...
        var _data2 = new FormData(),
            _casts = this.movieCredits.cast.slice(0, 10);
        _data2.append('casts', _casts.map(function (cast) {
          return cast.name;
        }));
        _data2.append('avatar_url', _casts.map(function (cast) {
          return cast['profile_path'];
        }));
         _data2.append('gender', _casts.map(function (cast) {
          return cast.gender;
        }));
          _data2.append('person_id', _casts.map(function (cast) {
            console.log(cast.id);
            return cast.id;
          }));
          _data2.append('api_key', this.api);
        return (0, _axios2.default)({
          method: 'post',
          url: importMovieLocalize.ajax_url,
          params: {
     ...
     */
    getMovieCollection: function getMovieCollection() {
      var _this7 = this;
      ...
      return (0, _axios2.default)({
        ...
        _this7.movieCollection = response.data;
      }).catch(function (error) {
        console.log(error);
      });
    },
     ...
     */
    sendPosterSrc: function sendPosterSrc() {
      var _this8 = this;
      ...
      if (this.option == 'movie') {
        ...
        return (0, _axios2.default)({
          ...
          _this8.mediaID = response.data.id;
        }).catch(function (error) {
          console.log(error);
        });
      } else {
     ...
     */
    sendBannerSrc: function sendBannerSrc() {
      var _this9 = this;
      ...
      if (this.option == 'movie') {
        ...
        return (0, _axios2.default)({
          ...
          _this9.bannerID = response.data.id;
          _this9.bannerURL = response.data.url;
    ...
    updateMovies: function updateMovies() {
      ...
      var data = {};
      var url = importMovieLocalize.rest_url + ("wp/v2/ht_show/" + this.postID);
      if (this.option == 'movie') {
      ...
      if (this.movieGenres && this.movieGenres != 0 ) {
        data['mv_genre'] = this.movieGenres;
      }
      if (this.movieKeywords && this.movieKeywords != 0) {
            data['mv_keyword'] = this.movieKeywords;
          }
          if (this.movieNetworks && this.movieNetworks != 0) {
             data['networks'] = this.movieNetworks;
        }
      if (this.movieCast) {
    ...
    importMovies: function importMovies() {
      ...
      _axios2.default.all([this.createMovies(), this.sendPosterSrc(), this.sendBannerSrc(), this.getMovieCollection(), this.getMovieGenres(), this.getMovieCast(), this.getMovieVideos(),this.getMovieKeywords(),this.getWatchProviders()]).then(_axios2.default.spread(function () {
        _this11.updateMovies();
      }));
    },
    ...
    importTV: function importTV() {
      ...
      _axios2.default.all([this.createMovies(), this.sendPosterSrc(), this.sendBannerSrc(), this.getMovieGenres(), this.getMovieCast(), this.getMovieVideos(),this.getMovieKeywords(),this.getWatchProviders()]).then(_axios2.default.spread(function () {
        _this12.updateMovies();
      }));
    },

    importMedia: function importMedia() {
    ...
    url: importMovieLocalize.ajax_url,
    params: {
      action: 'ht_check_tmdb_duplicate',
      id:id
    },
    data: {
      id: id
    ...
    if (res.data.success && res.data.data.exists) {
      ...
      this.$swal({
        ...
        text: "This movie/show already exists.",
        type: "info",
        showCloseButton: true
      });
...
var _vueMultiselect = __webpack_require__(18);

var _vueMultiselect2 = _interopRequireDefault(_vueMultiselect);

var _vueSweetalert = __webpack_require__(19);

var _vueSweetalert2 = _interopRequireDefault(_vueSweetalert);

var _searchMovie = __webpack_require__(25);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9e2bf502_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_searchMovie_vue__ = __webpack_require__(50);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_searchMovie_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9e2bf502_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_searchMovie_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\js\\components\\searchMovie.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9e2bf502", Component.options)
  } else {
    hotAPI.reload("data-v-9e2bf502", Component.options)
  }
...
var update = __webpack_require__(28)("bec20c34", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e2bf502\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./searchMovie.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e2bf502\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./searchMovie.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7347fa63_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_import_button_vue__ = __webpack_require__(49);
var disposed = false
var normalizeComponent = __webpack_require__(6)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_import_button_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7347fa63_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_import_button_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\js\\components\\import_button.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7347fa63", Component.options)
  } else {
    hotAPI.reload("data-v-7347fa63", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "buttons column" }, [
      _c(
        "a",
        {
          staticClass: "button is-info",
          class: { "is-loading": _vm.isLoading },
          on: { click: _vm.importMedia }
        },
        [_vm._m(0), _vm._v("\n            Import Movie\n        ")]
      )
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7347fa63", esExports)
  }
}
  ...
  return _c("div", [
    _c("div", { staticClass: "field column is-12" }, [
      _c("label", { staticClass: "label" }, [
        _vm._v("Search Movie / TV Show by Title")
      ]),
      _vm._v(" "),
                  ...
                  _c(
                    "multiselect",
                    {
                      attrs: {
                        ...
                        options: _vm.movies,
                        searchable: true,
                        loading: !_vm.selectedMovies ? false : _vm.isLoading,
                  ...
                  _c(
                    "multiselect",
                    {
                      attrs: {
                        id: "ajax",
                        "custom-label":
                          _vm.selectedOption.value === "movie"
                            ? _vm.customMovieLabel
                            : _vm.customShowLabel,
                        "track-by": "id",
                        placeholder: "Type to search",
                        "open-direction": "bottom",
        ...
        ? _c("table", { staticClass: "table is-fullwidth" }, [
            ...
            _c("tbody", [
              _c(
                ...
                [
                  _vm.selectedOption.value === "movie"
                    ? [
                        _c("th", [_vm._v(_vm._s(_vm.selectedMovies.id))]),
                        _vm._v(" "),
                        _c("td", [
                          _c("img", {
                            staticClass: "avatar",
                            attrs: {
                              src:
                                ...
                                _vm.selectedMovies.poster_path,
                              alt: "Avatar"
                            }
                          })
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(_vm.selectedMovies.title))]),
                        _vm._v(" "),
                        _c("td", { staticClass: "overview" }, [
                          _vm._v(_vm._s(_vm.selectedMovies.overview))
                        ]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(_vm.selectedMovies.release_date))
                        ])
                      ]
                    : [
                        _c("th", [_vm._v(_vm._s(_vm.selectedMovies.id))]),
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(_vm.selectedMovies.name))]),
                        _vm._v(" "),
                        _c("td", { staticClass: "overview" }, [
                          _vm._v(_vm._s(_vm.selectedMovies.overview))
                        ]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(_vm.selectedMovies.first_air_date))
                        ])
                      ]
                ],
                2
            ...
            _c(
              ...
              [
                _c("import-button", {
                  attrs: {
                    currentmovies: _vm.selectedMovies,
                    api: _vm.apiKey,
                    option: _vm.selectedOption.value
                  },
                  on: {
                    "clear-movies": function($event) {
                      _vm.movies = $event
                    },
                    "clear-selected-movie": function($event) {
                      _vm.selectedMovies = $event
                    }
                  }
                })
              ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9e2bf502", esExports)
  }
}
