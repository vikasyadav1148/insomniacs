...
<?php
		...
		$seasons = fw_get_db_post_option( $post->ID, 'seasons' );
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="movie-poster sticky-sb-movie">
                        <?php the_post_thumbnail( 'blockter-poster-movie-single'); ?>
                ...
                <div class="col-md-8">
                    <div class="movie-single-content main-content">
                      ...
                      //  $tmdbId=get_post_meta($post->ID,'_tmdb_id',true);
                         ...
                         echo  do_shortcode('[ht_movie_providers id="'.$post->ID.'" type="tv"]');
                         ?>
                        <div class="share-buttons">
                            <div class="favorite-btn tvshow">
                                <?php if ( is_user_logged_in() ) : ?>
                                <?php
											$meta_key_show = 'favourite_show_id';
											$current_fav_show_id = get_user_meta(  $current_user->ID, $meta_key_show );
											$new_fav_show_id = get_the_ID();
										...
										?>
                                <button data-user="<?php echo $current_user->ID; ?>" data-tvshow="<?php the_ID(); ?>"
                                    class="<?php echo esc_attr($fav_class); ?>">
                        ...
                        <div class="rate-average">
                            <div class="left-it">
                                ...
                                <div class="inner-cmt-infor">
                                    ...
                                    <span class="rv">
                                        <?php
															printf( _n( '1 Review', '%1$s Reviews', get_comments_number($post->ID), 'blockter' ),
                            ...
                            <div class="right-it">
                                <span
                                    class="rate-title"><?php echo esc_html__("Rate this show: ", 'blockter'); ?></span>
                            ...
                            <div class="tabs">
                                <nav class="main-nav">
                                    ...
                                    <ul class="tab-links tabs-mv">
                                        ...
                                        <li><a href="#seasons"><?php esc_html_e('Seasons', 'blockter'); ?></a></li>
                                        <li><a href="#media"> <?php esc_html_e('Media', 'blockter'); ?></a></li>
                                        <li><a href="#cast"><?php esc_html_e('Cast', 'blockter'); ?></a></li>
                                        <li><a
                                                href="#moviesrelated"><?php esc_html_e('Related Shows', 'blockter'); ?></a>
                                        </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="overview-left-ct">                                                    
                                                    ...
                                                    <div class="overview-ct"><?php echo wp_kses_post($overview); ?>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="overview-sb-it">
                                                                ...
                                                                <h6><?php esc_html_e('First Air Date: ', 'blockter'); ?>
                                                                </h6>
                                                                <span
                                                                    class="white-text"><?php echo esc_html($first_air_date); ?></span>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="overview-sb-it">
                                                                <?php if(!empty($episode_runtime)): ?>
                                                                <h6><?php esc_html_e('Episode Runtime: ', 'blockter'); ?>
                                                                </h6>
                                                                <span
                                                                    class="white-text"><?php echo esc_html($episode_runtime); ?></span>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="overview-sb-it">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="overview-sb-it">
                                                                ...
                                                                <h6><?php esc_html_e('Creator: ', 'blockter'); ?></h6>
                                                                <span
                                                                    class="white-text"><?php echo esc_html($creators); ?></span>
                                                                <?php endif;?>
                                                            </div>
                                                            <div class="overview-sb-it">
                                                                <?php if(!empty($creators)): ?>
                                                                <h6><?php esc_html_e('Production Companies: ', 'blockter'); ?>
                                                                </h6>
                                                                <span
                                                                    class="white-text"><?php echo esc_html($production); ?></span>
                                                                <?php endif;?>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="overview" class="tab active">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="overview-left-ct">
                                                    <h2><?php esc_html_e('Overview', 'blockter');; ?></h2>
                                                    <p class="overview-ct"><?php echo wp_kses_post($overview); ?></p>
                                                ...
                                                <div class="cast-it">
                                                    ...
                                                    <div class="ov-it-title">
                                                        ...
                                                        <a href="#cast" class="media-tab">View all cast</a>
                                                    </div>
                                                    <?php endif; ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="overview-sb-it">
                                                    <?php if(!empty($creators)): ?>
                                                    <h6><?php esc_html_e('Creator: ', 'blockter'); ?></h6>
                                                    <span class="white-text"><?php echo esc_html($creators); ?></span>
                                                    <?php endif;?>
                                                </div>
                                                ...
                                                <div class="overview-sb-it">
                                                    <?php if(!empty($first_air_date)): ?>
                                                    <h6><?php esc_html_e('Fist Air Date: ', 'blockter'); ?></h6>
                                                    <span
                                                        class="white-text"><?php echo esc_html($first_air_date); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="overview-sb-it">
                                                    <?php if(!empty($episode_runtime)): ?>
                                                    <h6><?php esc_html_e('Episode Runtime: ', 'blockter'); ?></h6>
                                                    <span
                                                        class="white-text"><?php echo esc_html($episode_runtime); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="overview-sb-it">
                                                    ...
                                                    <h6><?php esc_html_e('Production Companies:', 'blockter'); ?></h6>
                                                    <span class="white-text"><?php echo esc_html($production); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="overview-sb-it">
                                                    <h6>More Show Details</h6>
                                                    <?php echo do_shortcode('[tv_show_details id="'.get_the_ID().'" slug="'.get_the_title().'"]'); ?>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="cast-it">
                                                    <div class="ov-it-title">
                                                        ...
                                                        <a href="#reviews" class="media-tab">View all reviews</a>
                                                    </div>
                                                        ...
                                                        <li id="comment-<?php echo esc_attr( $comment->comment_ID ); ?>"
                                                            ...
                                                            <article
                                                                ...
                                                                <footer class="comment-meta">
                                                                        ...
                                                                        <div class="flex-it-inner">
                                                                            ...
                                                                            <div class="comment-content">
                                                                                <div class="flex-it-ava">
                                                                                    <b
                                                                                        class="fn"><?php echo esc_html( $comment->comment_author ); ?></b>
                                                                                    <?php  ?>
                                                                                    <div class="comment-metadata">
                                                                                        <a
                                                                                            href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
                                                                                            <time
                                                                                                datetime="<?php echo get_comment_time( 'c', $comment->comment_ID ); ?>">
                                                                                                <?php
																																					printf(
                                                                                ...
                                                                                <?php if ( $feedback != null ) : ?>
                                                                                <span
                                                                                    class="rate-stars"><?php echo fw_ext_feedback( $post->ID ); ?></span>
                                                                                <?php endif; ?>
                                                                            </div><!-- .comment-content -->
                                                                    ...
                                                                    <p><?php echo esc_html( $comment->comment_content ); ?>
                                                                    </p>
                                                                </footer><!-- .comment-meta -->
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="season">
                                                    <div class="season__img">
                                                        <?php if ( ! empty( $season['poster_path'] ) ): ?>
                                                        <img src="<?php echo esc_url( $season['poster_path'] ); ?>"
                                                            alt="<?php echo esc_attr( 'TV Show Poster', 'blockter' ); ?>">
                                                        <?php endif ?>
                                                    </div>
                                                    <div class="season__textcontent">
                                                        <?php if ( ( $season['season_number'] >= 0) ): ?>
                                                        <h3 class="season__title">
                                                            <?php echo sprintf( __( 'Season %d', 'blockter'), $season['season_number'] ); ?>
                                                            <!-- <span class="vote-average">
                                                                <?php //echo do_shortcode('[season_vote_details slug="'.get_the_title().'"]'); ?>
                                                            </span> -->
                                                        </h3>
                                                        <?php endif ?>
                                                        <?php if ( ! empty( $season['episode_count'] ) ): ?>
                                                        <p class="season__detail">
                                                            <?php echo sprintf( __( '%d Episodes', 'blockter' ), $season['episode_count'] ); ?>
                                                        </p>
                                                        <?php endif ?>
                                                        <?php if ( ! empty( $season['air_date'] ) ): ?>
                                                        <p class="season__detail">
                                                            <?php echo sprintf( __( 'Air Date: %s', 'blockter' ), $season['air_date'] ); ?>
                                                        </p>
                                                        <?php endif ?>
                                                        <?php if ( ! empty( $season['overview'] ) ): ?>
                                                        <p class="season__detail">
                                                            <?php echo esc_html( $season['overview'] ); ?></p>
                                                        <?php endif ?>
                                                    </div>
                                                </div>
                                                <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="sub-mv-title">
                                                    <h2><?php echo esc_html__("Related Shows To", 'blockter'); ?></h2>
